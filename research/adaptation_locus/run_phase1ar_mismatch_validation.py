"""Launch Phase-1A-R Step 3 mismatch causal validation."""
...
WORLD = REPO / "simulation" / "worlds" / "four_wheel_track_phase1ar_mismatch.wbt"
...
def main() -> int:
    out = REPO / "results" / "adaptation_locus_phase1ar" / "mismatch_validation"
